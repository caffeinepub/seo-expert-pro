...
export class Backend implements backendInterface {
    ...
    async createBlogPost(arg0: string, arg1: string, arg2: string, arg3: Array<string>, arg4: string, arg5: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getChatbotLogs(): Promise<Array<ChatbotLog>> {
        if (this.processError) {
            try {
    ...
    async logChatbotMessage(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
