import { u as useParams, j as jsxRuntimeExports, L as Link, m as motion, r as reactExports, S as Send } from "./index-h-JWjTnO.js";
import { B as Badge } from "./badge-BQeqxGc9.js";
import { I as Input } from "./input-JUp12OpM.js";
import { C as ChevronLeft, T as Textarea } from "./textarea-DJa9TkZy.js";
import { M as MapPin, N as Navbar, F as Footer } from "./Navbar-DznYYenD.js";
import { F as FileText, G as Globe, C as ChartNoAxesColumn, S as Star } from "./star-D0Xo_tvW.js";
import { S as Search } from "./search-D3Q28GAe.js";
import { A as ArrowLeft } from "./arrow-left-Cxm2l_Zg.js";
import { C as ChevronRight } from "./chevron-right-Bd3_zRgt.js";
import { A as ArrowRight } from "./arrow-right-aXik7pvA.js";
import { C as CircleCheckBig } from "./circle-check-big-aNmv7gqL.js";
const services = [
  {
    id: "on-page",
    icon: FileText,
    ...
    intro: "Optimize every element on your website so Google understands — and ranks — your content above the competition.",
    description: [
  ...
  },
  {
    ...
    intro: "Build the backlink profile and online reputation that signals trust to Google and pushes you above competitors.",
    description: [
  ...
  },
  {
    ...
    title: "Technical SEO",
    badge: "Fastest Wins",
    intro: "Fix the invisible technical barriers that stop Google from crawling, indexing, and ranking your pages.",
    description: [
  ...
  },
  {
    ...
    intro: "Find the exact search terms your ideal customers use — and build an SEO strategy that captures them at every stage.",
    description: [
  ...
  },
  {
    ...
    title: "Local SEO",
    badge: "High ROI",
    intro: "Dominate local search results and Google Maps so nearby customers find you first — and call you.",
    description: [
...
function QuoteForm({ serviceTitle }) {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block bg-[#38C98A]/20 text-[#38C98A] text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4", children: "Free Quote" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-extrabold text-white mb-3", children: [
                "Get a Quote for",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#38C98A]", children: serviceTitle })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/65 text-base max-w-xl mx-auto", children: "Tell us about your project and we'll get back to you within 24 hours." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/55 text-sm", children: [
                    ...
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#38C98A] font-semibold", children: serviceTitle }),
                    ". Expect a reply soon."
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
              ...
              "form",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-sm font-medium", children: "Service Interested In" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-11 bg-white/5 border border-white/10 rounded-md px-3 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#38C98A] font-semibold text-sm", children: serviceTitle }) })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "label",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/35 text-xs text-center", children: "No spam. No obligations. We typically respond within a few hours." })
                ]
              }
            )
          }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-extrabold text-[#0B2A43] mb-4", children: "Service Not Found" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 mb-8", children: "The service you're looking for doesn't exist or has been moved." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: "/services",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#F7F9FC]", children: [
        ...
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-2xl bg-[#38C98A]/20 flex items-center justify-center flex-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-7 h-7 text-[#38C98A]" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-[#38C98A]/20 text-[#38C98A] border-[#38C98A]/30 mb-2 px-3 py-0.5 text-xs", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-3 h-3 mr-1" }),
                  " ",
                  service.badge
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl sm:text-5xl font-extrabold text-white leading-tight", children: service.title })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#C7D2E0] text-lg max-w-2xl leading-relaxed", children: service.intro })
          ]
        }
      ) })
    ] }),
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-extrabold text-[#0B2A43] mb-6", children: "About This Service" }),
            service.description.map((para) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#F7F9FC] rounded-2xl p-6 border-l-4 border-[#38C98A]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-[#0B2A43] uppercase tracking-wider mb-3", children: "Who This Is For" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 leading-relaxed", children: service.whoFor })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#F7F9FC] rounded-2xl p-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "space-y-3", children: service.process.map((step, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600 text-sm leading-relaxed", children: step })
                  ]
                },
                step.slice(0, 30)
              )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-[#F7F9FC]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        transition: { duration: 0.5 },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-extrabold text-[#0B2A43] mb-2 text-center", children: "Pricing" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-center mb-10", children: "Transparent pricing — no hidden fees, no long-term lock-ins." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(QuoteForm, { serviceTitle: service.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 bg-white border-t border-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4", children: [
      prevService ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          to: "/services/$id",
      ...
      nextService ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          to: "/services/$id",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-[#38C98A] py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        transition: { duration: 0.5 },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-extrabold text-white mb-4", children: [
            "Ready to Get Started with ",
            service.title,
            "?"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/85 text-lg mb-8", children: "Let's talk about your goals. The audit is free and there's no obligation." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: "/contact",
