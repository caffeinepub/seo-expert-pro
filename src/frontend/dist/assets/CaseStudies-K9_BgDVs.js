const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CaseStudiesHero3D-D7zgFRG4.js","assets/index-BCNwlkVQ.js","assets/index-CIRZ4W5K.css","assets/react-three-fiber.esm-uZEeE8Xe.js","assets/three.module-DUeOZydE.js","assets/SectionParticlesBg-CG9J_vo7.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, r as reactExports, L as Link, _ as __vitePreload } from "./index-BCNwlkVQ.js";
import { N as Navbar, F as Footer } from "./Navbar-DshbXHrO.js";
import { T as TrendingUp } from "./trending-up-Lh9k9Ahi.js";
import { A as ArrowRight } from "./arrow-right-Cs1iEnyD.js";
import { A as ArrowUp } from "./arrow-up-DYGmTJ0T.js";
import "./search-B58CoGTb.js";
function toSlug(str) {
  return str.toLowerCase().replace(/[^a-z0-9]+/g, "-");
}
const CaseStudiesHero3D = reactExports.lazy(() => __vitePreload(() => import("./CaseStudiesHero3D-D7zgFRG4.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const SectionParticlesBg = reactExports.lazy(
  () => __vitePreload(() => import("./SectionParticlesBg-CG9J_vo7.js"), true ? __vite__mapDeps([5,1,2,3,4]) : void 0)
);
const cases = [
  {
