const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CaseStudiesHero3D-MbkyCqMM.js","assets/index-Bju-sJbZ.js","assets/index-PmuAY7gM.css","assets/react-three-fiber.esm-Dgo2wqnm.js","assets/three.module-DUeOZydE.js","assets/SectionParticlesBg-YFdk-d8m.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, r as reactExports, L as Link, _ as __vitePreload } from "./index-Bju-sJbZ.js";
...
import { A as ArrowUp } from "./arrow-up-HsviiUve.js";
import "./search-DvS1EmCV.js";
function toSlug(str) {
  return str.toLowerCase().replace(/[^a-z0-9]+/g, "-");
}
const CaseStudiesHero3D = reactExports.lazy(() => __vitePreload(() => import("./CaseStudiesHero3D-MbkyCqMM.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const SectionParticlesBg = reactExports.lazy(
  () => __vitePreload(() => import("./SectionParticlesBg-YFdk-d8m.js"), true ? __vite__mapDeps([5,1,2,3,4]) : void 0)
);
const cases = [
  {
