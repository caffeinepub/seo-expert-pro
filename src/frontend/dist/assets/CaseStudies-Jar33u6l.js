const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CaseStudiesHero3D-Bmzw7kpG.js","assets/index-h-JWjTnO.js","assets/index-DTBa6Rgv.css","assets/react-three-fiber.esm-B54cjZjw.js","assets/three.module-DUeOZydE.js","assets/SectionParticlesBg-U4WkwVMg.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, r as reactExports, L as Link, _ as __vitePreload } from "./index-h-JWjTnO.js";
...
import { A as ArrowUp } from "./arrow-up-fRRylUCe.js";
import "./search-D3Q28GAe.js";
function toSlug(str) {
  return str.toLowerCase().replace(/[^a-z0-9]+/g, "-");
}
const CaseStudiesHero3D = reactExports.lazy(() => __vitePreload(() => import("./CaseStudiesHero3D-Bmzw7kpG.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const SectionParticlesBg = reactExports.lazy(
  () => __vitePreload(() => import("./SectionParticlesBg-U4WkwVMg.js"), true ? __vite__mapDeps([5,1,2,3,4]) : void 0)
);
const cases = [
  {
