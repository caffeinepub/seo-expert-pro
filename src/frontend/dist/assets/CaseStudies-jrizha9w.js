const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CaseStudiesHero3D-DdD9ncOn.js","assets/index-BuyNZZ5R.js","assets/index-DkXr0MSM.css","assets/react-three-fiber.esm-C7TuV5Pu.js","assets/three.module-DUeOZydE.js","assets/SectionParticlesBg-CgZ0AhaO.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, r as reactExports, L as Link, _ as __vitePreload } from "./index-BuyNZZ5R.js";
...
import { A as ArrowUp } from "./arrow-up-C4XLdU5T.js";
import "./search-DGC0MEq5.js";
function toSlug(str) {
  return str.toLowerCase().replace(/[^a-z0-9]+/g, "-");
}
const CaseStudiesHero3D = reactExports.lazy(() => __vitePreload(() => import("./CaseStudiesHero3D-DdD9ncOn.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const SectionParticlesBg = reactExports.lazy(
  () => __vitePreload(() => import("./SectionParticlesBg-CgZ0AhaO.js"), true ? __vite__mapDeps([5,1,2,3,4]) : void 0)
);
const cases = [
  {
