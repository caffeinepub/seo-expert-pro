const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CaseStudiesHero3D-B8gCoGhb.js","assets/index-DSwezMv8.js","assets/index-BNaqOxWX.css","assets/react-three-fiber.esm-C5jeBHDt.js","assets/three.module-CDwbhIs2.js","assets/SectionParticlesBg-Cga-Z3EH.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, r as reactExports, L as Link, _ as __vitePreload } from "./index-DSwezMv8.js";
...
import { A as ArrowUp } from "./arrow-up-DloVOhOd.js";
import "./search-IBemnRt4.js";
function toSlug(str) {
  return str.toLowerCase().replace(/[^a-z0-9]+/g, "-");
}
const CaseStudiesHero3D = reactExports.lazy(() => __vitePreload(() => import("./CaseStudiesHero3D-B8gCoGhb.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const SectionParticlesBg = reactExports.lazy(
  () => __vitePreload(() => import("./SectionParticlesBg-Cga-Z3EH.js"), true ? __vite__mapDeps([5,1,2,3,4]) : void 0)
);
const cases = [
  {
